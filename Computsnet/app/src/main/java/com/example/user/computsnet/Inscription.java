...
public class Inscription extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button submitUp = (Button) findViewById(R.id.submit_signUp);
        ...
        submitUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(pseudo.getText().toString().length() > 0 && mdpasse.getText().toString().length() > 0 && confMdpasse.getText().toString().length() > 0){
                        ...
                        new HttpRequest(){
                            ...
                            public void onResponse(String response) {
                                ...
                                if(maliste.get(0).getNom().equals("true")){
                                    Intent mon_intent = new Intent(Inscription.this, Home.class);
